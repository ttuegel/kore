...
noParameterObjectSortAndSentence name =
    ( \location ->
          SortActualSort
              SortActual
                  {sortActualName = Id name location, sortActualSorts = []}
    , asSentence
          (SentenceSort
...
hookObjectSymbolSentence = attributeObjectSymbolSentence hookName hookObjectSort
