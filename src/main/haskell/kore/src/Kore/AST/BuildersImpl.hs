...
newtype ChildSort level =
    ChildSort (Sort level)
...
fillCheckSort ::
    ...
    -> PurePatternStub level variable
    -> PureMLPattern level variable
fillCheckSort desiredSort (SortedPatternStub SortedPattern { sortedPatternPattern = p
...
fillCheckPairSorts ::
       PurePatternStub level variable
    -> PurePatternStub level variable
    -> Either ( Sort level -> PureMLPattern level variable
              , Sort level -> PureMLPattern level variable) ( Sort level
                                                            , PureMLPattern level variable
                                                            , PureMLPattern level variable)
fillCheckPairSorts (UnsortedPatternStub first) (UnsortedPatternStub second) =
    Left (Fix . first, Fix . second)
fillCheckPairSorts (UnsortedPatternStub first) (SortedPatternStub SortedPattern { sortedPatternPattern = second
                                                                                , sortedPatternSort = s
                                                                                }) =
    Right (s, Fix (first s), Fix second)
fillCheckPairSorts (SortedPatternStub SortedPattern { sortedPatternPattern = first
                                                    , sortedPatternSort = s
                                                    }) (UnsortedPatternStub second) =
    Right (s, Fix first, Fix (second s))
fillCheckPairSorts (SortedPatternStub SortedPattern { sortedPatternPattern = p1
...
-}
unaryPattern ::
       (Sort level -> PureMLPattern level variable -> UnFixedPureMLPattern level variable)
    -> PurePatternStub level variable
    -> PurePatternStub level variable
unaryPattern constructor (SortedPatternStub SortedPattern { sortedPatternPattern = p
                                                          , sortedPatternSort = s
                                                          }) =
    SortedPatternStub
        SortedPattern
...
unarySortedPattern ::
    ...
    => (ResultSort level -> ChildSort level -> PureMLPattern level variable -> UnFixedPureMLPattern level variable)
...
-}
binaryPattern ::
       (Sort level -> PureMLPattern level variable -> PureMLPattern level variable -> UnFixedPureMLPattern level variable)
    -> PurePatternStub level variable
    -> PurePatternStub level variable
    -> PurePatternStub level variable
...
binarySortedPattern ::
       (MetaOrObject level, Show (variable level))
    => (ResultSort level -> ChildSort level -> PureMLPattern level variable -> PureMLPattern level variable -> UnFixedPureMLPattern level variable)
    -> Maybe (ChildSort level)
    -> PurePatternStub level variable
    -> PurePatternStub level variable
    -> PurePatternStub level variable
...
equalsM_ ::
       (MetaOrObject level, Show (variable level))
    => Maybe (Sort level)
    -> (PurePatternStub level variable -> PurePatternStub level variable -> PurePatternStub level variable)
equalsM_ s =
    binarySortedPattern
