...
instance (Pretty child, Pretty (variable Meta), Pretty (variable Object)) =>
    ...
    pretty =
        applyUnified (pretty . unRotate31) (pretty . unRotate31) .
        getUnifiedPattern
...
asMetaKorePattern ::
       Pattern Meta variable (KorePattern variable) -> KorePattern variable
asMetaKorePattern = asKorePattern

-- |View a 'Object' 'Pattern' as a 'KorePattern'
asObjectKorePattern ::
       Pattern Object variable (KorePattern variable) -> KorePattern variable
