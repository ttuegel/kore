...
have this sort.
-}
newtype ConditionSort level =
    ConditionSort (Sort level)
    deriving (Show, Eq)
...
makeEvaluatedAnd (ConditionSort sort) (ConditionUnevaluable first) (ConditionUnevaluable second) =
...
makeEvaluatedOr (ConditionSort sort) (ConditionUnevaluable first) (ConditionUnevaluable second) =
...
makeEvaluatedImplies (ConditionSort sort) (ConditionUnevaluable first) (ConditionUnevaluable second) =
    ( ConditionUnevaluable $
      asPurePattern $ ImpliesPattern $ Implies sort first second
    , ConditionProof)
...
makeEvaluatedIff (ConditionSort sort) (ConditionUnevaluable first) (ConditionUnevaluable second) =
