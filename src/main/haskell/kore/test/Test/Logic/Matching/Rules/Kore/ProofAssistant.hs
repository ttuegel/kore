...
import Kore.MetaML.AST (MetaMLPattern)
...
import Logic.Proof.Hilbert as HilbertProof (Proof(..), add, derive, emptyProof)
...
test_proofAssistant =
    testGroup
        ...
        [ runTestScript
              ...
              , testModusPonens (GoalId 2) (GoalId 3) (GoalId 1)
              , assertGoalCount 5
              ...
              , assertUnproven (GoalId 4)
              , assertUnproven (GoalId 5)
              , testModusPonens (GoalId 4) (GoalId 5) (GoalId 3)
              , assertGoalCount 5
              , assertPartlyProven (GoalId 1) (GoalNeeds [GoalId 3, GoalId 2])
              , assertUnproven (GoalId 2)
...
thingEqualsThing sort thing = metaEquals (ResultSort phiSort) sort thing thing

xEqualsX ::
       MetaEquals MetaSortVariable1 (MetaVariable MetaSortVariable1) (MetaVariable MetaSortVariable1) CharListSort
...
test_prop1 =
    testGroup
        "Propositional1"
        [ runTestScript
              "Fails if phi not matched on the first instance"
              [ testAddGoal
                    (metaImplies phiSort qphi' (metaImplies phiSort qpsi qphi))
                    (NewGoalId 1)
              , expectFailure (testProposition1 qphi qpsi (GoalId 1))
              ]
        , runTestScript
              "Fails if phi not matched on the second instance"
              [ testAddGoal
                    (metaImplies phiSort qphi (metaImplies phiSort qpsi qphi'))
                    (NewGoalId 1)
              , expectFailure (testProposition1 qphi qpsi (GoalId 1))
        ...
        , runTestScript
              ...
              [ testAddGoal
                    (metaImplies
                         ...
                         (metaImplies
                              phiSort
                              (metaImplies phiSort qphi qphi)
                              qphi))
                    (NewGoalId 1)
              , expectFailure (testProposition1 qphi qpsi (GoalId 1))
              ]
        , runTestScript
              "Fails with incompatible sorts"
              [ testAddGoal
                    (metaImplies
                         phiSort
                         qphi
                         (metaImplies
                              ...
                              qphi))
                    (NewGoalId 1)
              , expectFailure (testProposition1 qphi qpsiS (GoalId 1))
              ]
        , runTestScript
              "No alpha renaming for free variables"
              [ testAddGoal
                    (metaImplies phiSort qphi (metaImplies phiSort phi' qphi))
                    (NewGoalId 1)
              , expectFailure (testProposition1 qphi psi (GoalId 1))
              ]
        , runTestScript
              "Infers proposition"
              [ testAddGoal
...
test_prop2 =
    testGroup
        "Propositional2"
        [ runTestScript
              "Fails if phi1 is not matched on the first instance."
              [ testAddGoal
                    (metaImplies
                         phiSort
                         (metaImplies
                    ...
                    (NewGoalId 1)
              , expectFailure (testProposition2 phi1 phi2 phi3 (GoalId 1))
              ]
        , runTestScript
              "Fails if phi1 is not matched on the second instance."
              [ testAddGoal
                    (metaImplies
                         phiSort
                         (metaImplies
        ...
        , runTestScript
              "Fails if phi1 is not matched on the third instance."
              [ testAddGoal
                    (metaImplies
                         phiSort
                         (metaImplies
        ...
        , runTestScript
              "Fails if phi2 is not matched on the first instance."
              [ testAddGoal
                    (metaImplies
                         phiSort
                         (metaImplies
        ...
        , runTestScript
              "Fails if phi2 is not matched on the second instance."
              [ testAddGoal
                    (metaImplies
                         phiSort
                         (metaImplies
        ...
        , runTestScript
              "Fails if phi3 is not matched on the first instance."
              [ testAddGoal
                    (metaImplies
                         phiSort
                         (metaImplies
        ...
        , runTestScript
              "Fails if phi3 not matched on the second instance"
              [ testAddGoal
                    (metaImplies
                         phiSort
                         (metaImplies
...
test_prop3 =
    testGroup
        "Propositional3"
        [ runTestScript
              "Fails if phi1 not matched on the first instance"
              [ testAddGoal
                    (metaImplies
                         phiSort
                         (metaImplies
                    ...
                    (NewGoalId 1)
              , expectFailure (testProposition3 phi1 phi2 (GoalId 1))
              ]
        , runTestScript
              "Fails if phi1 not matched on the second instance"
              [ testAddGoal
                    (metaImplies
                         phiSort
                         (metaImplies
        ...
        , runTestScript
              "Fails if phi2 not matched on the first instance"
              [ testAddGoal
                    (metaImplies
                         phiSort
                         (metaImplies
        ...
        , runTestScript
              "Fails if phi2 not matched on the second instance"
              [ testAddGoal
                    (metaImplies
                         phiSort
                         (metaImplies
...
test_modusPonens =
    testGroup
        ...
        , runTestScript
              "Fails if propositions are reversed"
              [ testAddGoal phi1 (NewGoalId 1)
              , testAddGoal (metaImplies phiSort phi1 phi2) (NewGoalId 2)
              , testAddGoal phi2 (NewGoalId 3)
              , expectFailure (testModusPonens (GoalId 2) (GoalId 1) (GoalId 3))
              ]
        , runTestScript
              "Infers formula"
              [ testAddGoal phi1 (NewGoalId 1)
...
test_generalization =
    testGroup
        "Generalization"
        [ runTestScript
              "Fails if the patterns do not match"
              [ testAddGoal z (NewGoalId 1)
              , testAddGoal (metaForall xSort x y) (NewGoalId 2)
              , expectFailure (testGeneralization x (GoalId 1) (GoalId 2))
              ]
        , runTestScript
              "Fails if the variables does not match"
              [ testAddGoal y (NewGoalId 1)
              , testAddGoal (metaForall xSort x y) (NewGoalId 2)
              , expectFailure (testGeneralization z (GoalId 1) (GoalId 2))
              ]
        , runTestScript
              "Infers formula"
              [ testAddGoal y (NewGoalId 1)
              , testAddGoal (metaForall xSort x y) (NewGoalId 2)
              , testGeneralization x (GoalId 1) (GoalId 2)
              ]
        , runTestScript
              "Infers formula with free variable generalization"
...
test_variableSubstitution =
    testGroup
        ...
        [ runTestScript
              "Fails if the wrong variable is substituted"
              [ testAddGoal
                    (metaImplies xSort (metaForall xSort x x) y)
                    (NewGoalId 1)
              , expectFailure
        ...
        , runTestScript
              "Fails when substituting with the wrong variable"
              [ testAddGoal
                    (metaImplies xSort (metaForall xSort x x) y)
                    (NewGoalId 1)
              , expectFailure
        ...
        , runTestScript
              "Fails when capturing a variable"
              [ testAddGoal
                    (metaImplies
                         xSort
                         (metaForall
...
test_forall =
    testGroup
        "Forall"
        [ runTestScript
              "Fails when variable not matched 1"
              [ testAddGoal
                    (metaImplies
                         xSort
                    ...
                    (NewGoalId 1)
              , expectFailure (testForall z y x (GoalId 1))
              ]
        , runTestScript
              "Fails when variable not matched 2"
              [ testAddGoal
                    (metaImplies
                         xSort
                         ...
                         (metaImplies xSort y (metaForall xSort x x)))
                    (NewGoalId 1)
              , expectFailure (testForall x y x (GoalId 1))
              ]
        , runTestScript
              "Fails when variable not matched 3"
              [ testAddGoal
                    (metaImplies
                         xSort
                         (metaForall xSort x (metaImplies xSort y x))
        ...
        , runTestScript
              ...
              [ testAddGoal
                    (metaImplies
                         ...
                         (metaImplies xSort y (metaForall xSort x x)))
                    (NewGoalId 1)
              , expectFailure (testForall x z x (GoalId 1))
              ]
        , runTestScript
              "Fails when phi1 not matched 2"
              [ testAddGoal
                    (metaImplies
                         xSort
        ...
        , runTestScript
              ...
              [ testAddGoal
                    (metaImplies
                         ...
                         (metaImplies xSort y (metaForall xSort x x)))
                    (NewGoalId 1)
              , expectFailure (testForall x y z (GoalId 1))
              ]
        , runTestScript
              "Fails when phi2 not matched 2"
              [ testAddGoal
                    (metaImplies
                         xSort
        ...
        , runTestScript
              ...
              [ testAddGoal
                    ...
                    (NewGoalId 1)
              , expectFailure (testForall x x x (GoalId 1))
              ]
        , runTestScript
              "Succeeds"
              [ testAddGoal
                    (metaImplies
                         ...
                         (metaImplies xSort y (metaForall xSort x x)))
                    (NewGoalId 1)
              , testForall x y x (GoalId 1)
              ]
        , let qx = metaForall xSort x x
           in runTestScript
                  "Succeeds when x quantified in phi1"
                  [ testAddGoal
                        (metaImplies
                             xSort
...
instance (MetaSort s, MetaPattern s p1, MetaPattern s p2, MetaPattern s p3) =>
         ProperPattern Meta s (MetaSigma s p1 p2 p3) where
...
metaSigma ::
    ...
    -> p2
    -> p3
    -> MetaSigma s p1 p2 p3
metaSigma = MetaSigma

sigma2 ::
       MetaPattern CharListSort p1
    => p1
    -> MetaSigma CharListSort (MetaVariable CharListSort) p1 (MetaVariable CharListSort)
...
sigma2p ::
    ...
    => p1
    -> p2
    -> MetaSigma CharListSort p2 p1 p2
sigma2p phip psip = metaSigma phiSort psip phip psip

sigma3 ::
       MetaPattern CharListSort p1
    => p1
    -> MetaSigma CharListSort (MetaVariable CharListSort) (MetaVariable CharListSort) p1
...
instance (MetaSort s, MetaPattern s p1, MetaPattern s p2, MetaPattern s p3) =>
         ProperPattern Meta s (MetaSigmoid s p1 p2 p3) where
...
metaSigmoid ::
    ...
    -> p2
    -> p3
    -> MetaSigmoid s p1 p2 p3
metaSigmoid = MetaSigmoid

sigmoid2 ::
       MetaPattern CharListSort p1
    => p1
    -> MetaSigmoid CharListSort (MetaVariable CharListSort) p1 (MetaVariable CharListSort)
...
sigmoid2p ::
    ...
    => p1
    -> p2
    -> MetaSigmoid CharListSort p2 p1 p2
...
sigmaSymbol =
    SymbolOrAlias {symbolOrAliasConstructor = sigmaId, symbolOrAliasParams = []}
...
test_propagateOr =
    testGroup
        "PropagateOr"
        [ runTestScript
              "Fails if indexes do not match 1"
              [ testAddGoal
                    (metaImplies
                         phiSort
                         (sigma3 (metaOr phiSort phi1 phi2))
                         (metaOr phiSort (sigma2 phi1) (sigma2 phi2)))
                    (NewGoalId 1)
              , expectFailure
                    (testPropagateOr sigmaSymbol 1 phi1 phi2 (GoalId 1))
              ]
        , runTestScript
              "Fails if indexes do not match 2"
              [ testAddGoal
                    (metaImplies
                         phiSort
                         (sigma2 (metaOr phiSort phi1 phi2))
                         (metaOr phiSort (sigma3 phi1) (sigma2 phi2)))
                    (NewGoalId 1)
              , expectFailure
                    (testPropagateOr sigmaSymbol 1 phi1 phi2 (GoalId 1))
              ]
        , runTestScript
              "Fails if indexes do not match 3"
              [ testAddGoal
                    (metaImplies
                         phiSort
                         (sigma2 (metaOr phiSort phi1 phi2))
                         (metaOr phiSort (sigma2 phi1) (sigma3 phi2)))
                    (NewGoalId 1)
              , expectFailure
                    (testPropagateOr sigmaSymbol 1 phi1 phi2 (GoalId 1))
              ]
        , runTestScript
              "Fails if indexes do not match 4"
              [ testAddGoal
                    (metaImplies
                         phiSort
                         (sigma2 (metaOr phiSort phi1 phi2))
                    ...
                    (NewGoalId 1)
              , expectFailure
                    (testPropagateOr sigmaSymbol 2 phi1 phi2 (GoalId 1))
              ]
        , runTestScript
              "Fails if phi1 not matched 1"
              [ testAddGoal
                    (metaImplies
                         phiSort
        ...
        , runTestScript
              "Fails if phi1 not matched 2"
              [ testAddGoal
                    (metaImplies
                         phiSort
                         (sigma2 (metaOr phiSort phi1 phi2))
                         (metaOr phiSort (sigma2 psi) (sigma2 phi2)))
                    (NewGoalId 1)
              , expectFailure
                    (testPropagateOr sigmaSymbol 1 phi1 phi2 (GoalId 1))
              ]
        , runTestScript
              "Fails if phi1 not matched 3"
              [ testAddGoal
                    (metaImplies
                         phiSort
                         (sigma2 (metaOr phiSort phi1 phi2))
                    ...
                    (NewGoalId 1)
              , expectFailure
                    (testPropagateOr sigmaSymbol 1 psi phi2 (GoalId 1))
              ]
        , runTestScript
              "Fails if phi2 not matched 1"
              [ testAddGoal
                    (metaImplies
                         phiSort
                         (sigma2 (metaOr phiSort phi1 psi))
                         (metaOr phiSort (sigma2 phi1) (sigma2 psi)))
                    (NewGoalId 1)
              , expectFailure
                    (testPropagateOr sigmaSymbol 1 phi1 phi2 (GoalId 1))
              ]
        , runTestScript
              "Fails if phi2 not matched 2"
              [ testAddGoal
                    (metaImplies
                         phiSort
                         (sigma2 (metaOr phiSort phi1 phi2))
        ...
        , runTestScript
              ...
              [ testAddGoal
                    ...
                    (NewGoalId 1)
              , expectFailure
                    (testPropagateOr sigmaSymbol 1 phi1 psi (GoalId 1))
              ]
        , runTestScript
              "Fails if sigma not matched 1"
              [ testAddGoal
                    (metaImplies
                         phiSort
        ...
        , runTestScript
              "Fails if sigma not matched 2"
              [ testAddGoal
                    (metaImplies
                         phiSort
                         (sigma2 (metaOr phiSort phi1 phi2))
                         (metaOr phiSort (sigmoid2 phi1) (sigma2 phi2)))
                    (NewGoalId 1)
              , expectFailure
                    (testPropagateOr sigmaSymbol 1 phi1 phi2 (GoalId 1))
              ]
        , runTestScript
              "Fails if sigma not matched 3"
              [ testAddGoal
                    (metaImplies
                         phiSort
                         (sigma2 (metaOr phiSort phi1 phi2))
                         (metaOr phiSort (sigma2 phi1) (sigmoid2 phi2)))
                    (NewGoalId 1)
              , expectFailure
                    (testPropagateOr sigmaSymbol 1 phi1 phi2 (GoalId 1))
              ]
        , runTestScript
              "Fails if sigma not matched 4"
              [ testAddGoal
                    (metaImplies
                         phiSort
                         (sigma2 (metaOr phiSort phi1 phi2))
                    ...
                    (NewGoalId 1)
              , expectFailure
                    (testPropagateOr sigmoidSymbol 1 phi1 phi2 (GoalId 1))
              ]
        , runTestScript
              "Fails if extra patterns are different 1"
              [ testAddGoal
                    (metaImplies
                         phiSort
        ...
        , runTestScript
              "Fails if extra patterns are different 2"
              [ testAddGoal
                    (metaImplies
                         phiSort
        ...
        , runTestScript
              "Fails if extra patterns are different 3"
              [ testAddGoal
                    (metaImplies
                         phiSort
        ...
        , runTestScript
              "Fails if extra patterns are different 4"
              [ testAddGoal
                    (metaImplies
                         phiSort
                         (metaSigma phiSort phi (metaOr phiSort phi1 phi2) phi)
        ...
        , runTestScript
              "Fails if extra patterns are different 5"
              [ testAddGoal
                    (metaImplies
                         phiSort
                         (metaSigma phiSort phi (metaOr phiSort phi1 phi2) phi)
        ...
        , runTestScript
              "Fails if extra patterns are different 6"
              [ testAddGoal
                    (metaImplies
                         phiSort
                         (metaSigma phiSort phi (metaOr phiSort phi1 phi2) phi)
    ...
    testGroup
        ...
        [ runTestScript
              ...
              [ testAddGoal
                    ...
                    (NewGoalId 1)
              , expectFailure
                    (testPropagateExists sigmaSymbol 1 x phi (GoalId 1))
              ]
        , runTestScript
              "Fails if indexes do not match 2"
              [ testAddGoal
        ...
        , runTestScript
              ...
              [ testAddGoal
                    ...
                    (NewGoalId 1)
              , expectFailure
                    (testPropagateExists sigmaSymbol 2 x phi (GoalId 1))
              ]
        , runTestScript
              "Fails if variables do not match 1"
              [ testAddGoal
                    (metaImplies
                         phiSort
        ...
        , runTestScript
              "Fails if variables do not match 2"
              [ testAddGoal
                    (metaImplies
                         phiSort
                         (sigma2 (metaExists phiSort x phi))
        ...
        , runTestScript
              "Fails if variables do not match 3"
              [ testAddGoal
                    (metaImplies
                         phiSort
                         (sigma2 (metaExists phiSort x phi))
                    ...
                    (NewGoalId 1)
              , expectFailure
                    (testPropagateExists sigmaSymbol 1 y phi (GoalId 1))
              ]
        , runTestScript
              "Fails if formulas do not match 1"
              [ testAddGoal
                    (metaImplies
                         phiSort
        ...
        , runTestScript
              "Fails if formulas do not match 2"
              [ testAddGoal
                    (metaImplies
                         phiSort
                         (sigma2 (metaExists phiSort x phi))
        ...
        , runTestScript
              "Fails if formulas do not match 3"
              [ testAddGoal
                    (metaImplies
                         phiSort
                         (sigma2 (metaExists phiSort x phi))
                    ...
                    (NewGoalId 1)
              , expectFailure
                    (testPropagateExists sigmaSymbol 1 x psi (GoalId 1))
              ]
        , runTestScript
              "Fails if the additional patterns are different 1"
              [ testAddGoal
                    (metaImplies
                         phiSort
        ...
        , runTestScript
              "Fails if the additional patterns are different 2"
              [ testAddGoal
                    (metaImplies
                         phiSort
        ...
        , runTestScript
              "Fails if variable is unquantified"
              [ testAddGoal
                    (metaImplies
                         phiSort
                         (sigma2p (metaExists phiSort x phi) xEqualsX)
                         (metaExists phiSort x (sigma2p phi xEqualsX)))
                    (NewGoalId 1)
              , expectFailure
                    (testPropagateExists sigmaSymbol 1 x phi (GoalId 1))
              ]
        , runTestScript
              "Fails if the symbol is different 1"
              [ testAddGoal
                    (metaImplies
                         phiSort
        ...
        , runTestScript
              "Fails if the symbol is different 2"
              [ testAddGoal
                    (metaImplies
                         phiSort
        ...
        , runTestScript
              "Fails if the symbol is different 3"
              [ testAddGoal
                    (metaImplies
                         phiSort
                         (metaSigma phiSort phi (metaExists phiSort x phi) phi)
                    ...
                    (NewGoalId 1)
              , expectFailure
                    (testPropagateExists sigmoidSymbol 1 x phi (GoalId 1))
              ]
        , runTestScript
              "Succeeds"
              [ testAddGoal
        ...
        , runTestScript
              ...
              [ testAddGoal
                    ...
                    (NewGoalId 1)
              , testPropagateExists sigmaSymbol 1 x xEqualsX (GoalId 1)
              ]
        ]
    ...
    testGroup
        ...
        [ runTestScript
              ...
              , testAddGoal
                    ...
                    (NewGoalId 2)
              , expectFailure (testFraming sigmaSymbol 2 (GoalId 1) (GoalId 2))
              ]
        , runTestScript
              "Fails if symbols do not match"
              [ testAddGoal (metaImplies phiSort phi psi) (NewGoalId 1)
              , testAddGoal
                    (metaImplies
                         phiSort
                    ...
                    (NewGoalId 2)
              , expectFailure (testFraming sigmaSymbol 1 (GoalId 1) (GoalId 2))
              ]
        , runTestScript
              "Fails if hypothesis has wrong form"
        ...
        , runTestScript
              "Fails if anteceedent formulas do not match"
        ...
        , runTestScript
              "Fails if consequent formulas do not match"
        ...
        , runTestScript
              ...
              , testAddGoal
                    (metaImplies
                         ...
                         (metaSigma phiSort psi psi psi))
                    (NewGoalId 2)
              , testFraming sigmaSymbol 1 (GoalId 1) (GoalId 2)
              ]
        ]
...
test_existence =
    testGroup
        "Existence"
        [ runTestScript
              "Fails if the variable differs 1"
              [ testAddGoal (metaExists xSort y x) (NewGoalId 1)
              , expectFailure (testExistence x (GoalId 1))
              ]
        , runTestScript
              "Fails if the variable differs 2"
              [ testAddGoal (metaExists xSort x y) (NewGoalId 1)
              , expectFailure (testExistence x (GoalId 1))
              ]
        , runTestScript
              "Fails if the variable differs 3"
              [ testAddGoal (metaExists xSort x x) (NewGoalId 1)
              , expectFailure (testExistence y (GoalId 1))
              ]
        , runTestScript
              "Succeeds"
              [ testAddGoal (metaExists xSort x x) (NewGoalId 1)
              , testExistence x (GoalId 1)
              ]
        ]
...
test_singletonVariable =
    testGroup
                    ...
                    (metaNot
                         ...
                         (metaAnd
                              ...
                              (metaSigmoid
                                   ...
                                   phi2)))
                    (NewGoalId 1)
              , expectFailure (testSingvar phi phi1 [1] [0] (GoalId 1))
              ]
        , runTestScript
              "Fails if the variable differs 2"
              [ testAddGoal
                    ...
                    (metaNot
                         ...
                         (metaAnd
                              ...
                              (metaSigmoid
                                   ...
                                   phi2)))
                    (NewGoalId 1)
              , expectFailure (testSingvar phi3 phi1 [1] [0] (GoalId 1))
              ]
        , runTestScript
              "Fails if the pattern differs 1"
              [ testAddGoal
                    (metaNot
                         phiSort
                         (metaAnd
        ...
        , runTestScript
              "Fails if the pattern differs 2"
              [ testAddGoal
                    (metaNot
                         phiSort
                         (metaAnd
        ...
        , runTestScript
              "Fails if the pattern differs 3"
              [ testAddGoal
                    (metaNot
                         phiSort
                         (metaAnd
                              ...
                              (metaSigmoid
                                   ...
                                   phi2)))
                    (NewGoalId 1)
              , expectFailure (testSingvar phi phi3 [1] [0] (GoalId 1))
              ]
        , runTestScript
              "Fails if the path is broken 1"
              [ testAddGoal
                    (metaNot
                         phiSort
                         (metaAnd
                              ...
                              (metaSigmoid
                                   ...
                                   phi2)))
                    (NewGoalId 1)
              , expectFailure (testSingvar phi phi1 [] [0] (GoalId 1))
              ]
        , runTestScript
              "Fails if the path is broken 2"
              [ testAddGoal
                    (metaNot
                         phiSort
                         (metaAnd
                              ...
                              (metaSigmoid
                                   ...
                                   phi2)))
                    (NewGoalId 1)
              , expectFailure (testSingvar phi phi1 [1] [] (GoalId 1))
              ]
        , runTestScript
              "Fails if the path is broken 3"
              [ testAddGoal
                    (metaNot
                         phiSort
                         (metaAnd
                              ...
                              (metaSigmoid
                                   ...
                                   phi2)))
                    (NewGoalId 1)
              , expectFailure (testSingvar phi phi1 [1, 0] [0] (GoalId 1))
              ]
        , runTestScript
              "Fails if the path is broken 4"
              [ testAddGoal
                    (metaNot
                         phiSort
                         (metaAnd
                    ...
                    (metaNot
                         ...
                         (metaAnd
                              ...
                              (metaSigmoid
                                   ...
                                   phi2)))
                    (NewGoalId 1)
              , expectFailure (testSingvar phi phi1 [0] [0] (GoalId 1))
              ]
        , runTestScript
              "Fails if the path is broken 7"
              [ testAddGoal
                    (metaNot
                         phiSort
                         (metaAnd
                              ...
                              (metaSigmoid
                                   ...
                                   phi2)))
                    (NewGoalId 1)
              , expectFailure (testSingvar phi phi1 [2] [0] (GoalId 1))
              ]
        , runTestScript
              "Fails if the path is broken 8"
              [ testAddGoal
                    (metaNot
                         phiSort
                         (metaAnd
                              ...
                              (metaSigmoid
                                   ...
                                   phi2)))
                    (NewGoalId 1)
              , expectFailure (testSingvar phi phi1 [3] [0] (GoalId 1))
              ]
        , runTestScript
              "Fails if the path is broken 9"
              [ testAddGoal
                    (metaNot
                         phiSort
                         (metaAnd
                              ...
                              (metaSigmoid
                                   ...
                                   phi2)))
                    (NewGoalId 1)
              , expectFailure (testSingvar phi phi1 [1] [-1] (GoalId 1))
              ]
        , runTestScript
              "Fails if the path is broken 10"
              [ testAddGoal
                    (metaNot
                         phiSort
                         (metaAnd
        ...
        , runTestScript
              "Fails if the path is broken 11"
              [ testAddGoal
                    (metaNot
                         phiSort
                         (metaAnd
                              ...
                              (metaSigmoid
                                   ...
                                   phi2)))
                    (NewGoalId 1)
              , expectFailure (testSingvar phi phi1 [1] [3] (GoalId 1))
              ]
        , runTestScript
              "Succeeds"
              [ testAddGoal
                    (metaNot
                         ...
                         (metaAnd
                              ...
                              (metaSigmoid
                                   ...
                                   phi2)))
                    (NewGoalId 1)
              , testSingvar phi phi1 [1] [0] (GoalId 1)
              ]
        , runTestScript
              "Succeeds with long paths"
              [ testAddGoal
                    (metaNot
                         phiSort
                         (metaAnd
                              ...
                              (metaSigmoid
                                   ...
                                   phi2)))
                    (NewGoalId 1)
              , testSingvar phi phi1 [1, 2] [0] (GoalId 1)
              ]
        ]
...
type MLProof
     = Proof GoalId (MLRule (SymbolOrAlias Meta) (Variable Meta) (MetaMLPattern Variable)) (MetaMLPattern Variable)
...
addGoal :: CommonKorePattern -> NewGoalId -> MLProof -> Either String MLProof
...
modusPonens :: GoalId -> GoalId -> GoalId -> MLProof -> Either String MLProof
modusPonens phiId phiImpliesPsiId conclusionId proof = stringError modusPonens'
  where
    modusPonens' = do
...
proposition1 phip psip conclusionId proof = stringError proposition1'
  where
    proposition1' = do
        conclusionFormula <- lookupFormula conclusionId proof
        derive proof conclusionId conclusionFormula =<<
            (Propositional1 <$> patternKoreToPure Meta phip <*>
...
proposition2 ::
    ...
    -> MLProof
    -> Either String MLProof
proposition2 phi1p phi2p phi3p conclusionId proof = stringError proposition2'
  where
    proposition2' = do
        conclusionFormula <- lookupFormula conclusionId proof
        derive proof conclusionId conclusionFormula =<<
            (Propositional2 <$> patternKoreToPure Meta phi1p <*>
...
proposition3 ::
    ...
    -> MLProof
    -> Either String MLProof
proposition3 phi1p phi2p conclusionId proof = stringError proposition3'
  where
    proposition3' = do
        conclusionFormula <- lookupFormula conclusionId proof
        derive proof conclusionId conclusionFormula =<<
            (Propositional3 <$> patternKoreToPure Meta phi1p <*>
             patternKoreToPure Meta phi2p)
...
variableSubstitution ::
    ...
    -> MLProof
    -> Either String MLProof
variableSubstitution substituting substituted unsubstitutedPattern conclusionId proof =
...
forallRule ::
    ...
    -> MLProof
    -> Either String MLProof
forallRule variable phi1p phi2p conclusionId proof = stringError forallFormula'
  where
    forallFormula' = do
        conclusionFormula <- lookupFormula conclusionId proof
        derive proof conclusionId conclusionFormula =<<
            (ForallRule variable <$> patternKoreToPure Meta phi1p <*>
             patternKoreToPure Meta phi2p)

generalization ::
       Variable Meta -> GoalId -> GoalId -> MLProof -> Either String MLProof
generalization variable phiId conclusionId proof = stringError generalization'
  where
    generalization' = do
        conclusionFormula <- lookupFormula conclusionId proof
        derive
...
propagateOr ::
    ...
    -> MLProof
    -> Either String MLProof
propagateOr symbol idx phi1p phi2p conclusionId proof = stringError propagateOr'
  where
    propagateOr' = do
        conclusionFormula <- lookupFormula conclusionId proof
        derive proof conclusionId conclusionFormula =<<
            (PropagateOr symbol idx <$> patternKoreToPure Meta phi1p <*>
             patternKoreToPure Meta phi2p)
...
existence :: Variable Meta -> GoalId -> MLProof -> Either String MLProof
existence variable conclusionId proof = stringError existence'
  where
    existence' = do
        conclusionFormula <- lookupFormula conclusionId proof
        derive proof conclusionId conclusionFormula (Existence variable)
...
singvar ::
    ...
    -> MLProof
    -> Either String MLProof
singvar variable phip path1 path2 conclusionId proof = stringError singvar'
  where
    singvar' = do
        conclusionFormula <- lookupFormula conclusionId proof
        derive proof conclusionId conclusionFormula =<<
            (Singvar variable <$> patternKoreToPure Meta phip <*> pure path1 <*>
             pure path2)
                ...
                Just rule ->
                    snd
                        (foldl'
                             ...
                             (fmap goalStateAndIndex rule))
  where
    goalStateAndIndex idx = (idx, goalState idx proof)
    combineStates (idx, Nothing) _ = (idx, Nothing)
    combineStates (idx, _) (_, Nothing) = (idx, Nothing)
    ...
    combineStates (idx, Just (GoalPartlyProven (GoalNeeds idxs))) (childIdx, _) =
        (idx, Just (GoalPartlyProven (GoalNeeds (childIdx : idxs))))
    combineStates _ _ =
        error "`goalState` helper `combineStates` case not implemented"

lookupGoal :: GoalId -> MLProof -> Maybe (MetaMLPattern Variable)
lookupGoal goalId proof = snd <$> Map.lookup goalId (index proof)

lookupFormula ::
       GoalId -> MLProof -> Either (Error MLError) (MetaMLPattern Variable)
...
testModusPonens ::
       GoalId -> GoalId -> GoalId -> (String, MLProof -> Either String MLProof)
testModusPonens implierId implicationId impliedId =
    ( "modus ponens with phi=" ++
      show implierId ++
      " phi->psi=" ++ show implicationId ++ " and psi=" ++ show impliedId
...
testProposition1 phip psip conclusion =
    ( "proposition 1 with phi=" ++
      show patPhi ++ " psi=" ++ show patPsi ++ " conclusion=" ++ show conclusion
...
testProposition2 phi1p phi2p phi3p conclusion =
    ( "proposition 2 with phi1=" ++
      show pat1 ++
      " phi2=" ++
      show pat2 ++ " phi3=" ++ show pat3 ++ " conclusion=" ++ show conclusion
...
testProposition3 phi1p phi2p conclusion =
    ( "proposition 3 with phi1=" ++
      show pat1 ++ " phi2=" ++ show pat2 ++ " conclusion=" ++ show conclusion
...
testVariableSubstitution ::
    ...
    -> GoalId
    -> (String, MLProof -> Either String MLProof)
testVariableSubstitution substituting substituted unsubstitutedPattern conclusion =
    ( "variable substitution with y=" ++
      show substituting ++
      " and x=" ++ show substituted ++ " and phi(x)=" ++ show phip
...
testForall ::
    ...
    -> GoalId
    -> (String, MLProof -> Either String MLProof)
testForall variable phi1p phi2p conclusion =
    ( "forall with x=" ++
      show var1 ++ " and phi1=" ++ show pat1 ++ " and phi2(x)=" ++ show pat2
...
testGeneralization variable phiId conclusionId =
    ( "generalization with x=" ++ show var ++ " phi=" ++ show phiId
...
testPropagateOr symbol idx phi1p phi2p conclusionId =
    ( "propagate or with sigma=" ++
      show symbol ++
      " idx=" ++ show idx ++ " phi1=" ++ show pat1 ++ " phi2=" ++ show pat2
...
testPropagateExists symbol idx variable phip conclusionId =
    ( "propagate exists with sigma=" ++
      show symbol ++
      " idx=" ++ show idx ++ " x=" ++ show var ++ " phi=" ++ show pat
...
testFraming symbol idx hypothesisId conclusionId =
    ( "framing with sigma=" ++
      show symbol ++ " idx=" ++ show idx ++ " hypothesis=" ++ show hypothesisId
...
testExistence variable conclusionId =
    ("existence with var=" ++ show var, existence var conclusionId)
  where
    var = asMetaVariable variable
...
testSingvar variable phip path1 path2 conclusionId =
    ( "singvar" ++
      " with var=" ++
      show var ++
      " phi=" ++ show pat ++ " path1=" ++ show path1 ++ " path2=" ++ show path2
...
assertGoalCount count =
    ("expecting the goal count to be " ++ show count, goalCountAssertion count)
...
goalAssertion ::
       GoalId -> CommonKorePattern -> (MLProof -> Either String MLProof)
...
assertPartlyProven ::
       GoalId -> GoalNeeds -> (String, MLProof -> Either String MLProof)
...
partlyProvenAssertion ::
       GoalId -> GoalNeeds -> (MLProof -> Either String MLProof)
            ...
            if actualDependencies /= expectedDependencies
                then Left
                         ("different unproven dependencies, expected=" ++
                          ...
                          " actual=" ++ show actualDependencies)
                else Right proof
        state -> Left ("the goal is " ++ show state)
...
runTestScript ::
       String -> [(String, MLProof -> Either String MLProof)] -> TestTree
...
expectFailure (actionDescription, action) =
    ( "expecting failure for action: " ++ actionDescription ++ "'"
    , failureExpected action)

failureExpected ::
       (MLProof -> Either String MLProof) -> MLProof -> Either String MLProof
