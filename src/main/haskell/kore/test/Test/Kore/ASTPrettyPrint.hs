module Test.Kore.ASTPrettyPrint
    ( test_astPrettyPrint
    ) where
...
import Kore.Implicit.ImplicitSorts (charMetaSort)
...
test_astPrettyPrint =
               ...
               (prettyPrintToString
                    (UnifiedMeta
                         Variable
                             ...
                             , variableSort =
                                   SortVariableSort
                                       (SortVariable (testId "#sv"))
                             })))
    , testCase
          "Object unified variable"
          (assertEqual
               ""
    ...
    , testCase
          ...
          (assertEqual
               ...
               (prettyPrintToString (Just (testId "v" :: Id Object))))
    , testCase
          "Maybe - Nothing"
          (assertEqual
               ""
    ...
    , testCase
          ...
          (assertEqual
               ...
               ("Fix (TopPattern (Top (SortActualSort SortActual\n" ++
                ...
                "    , sortActualSorts = []\n" ++ "    })))")
               (prettyPrintToString
                    (Fix (TopPattern (Top charMetaSort)) :: MetaMLPattern Variable)))
    ]
