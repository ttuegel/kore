...
import Kore.AST.Builders (sort_)
...
objectSortParserTests =
    parseTree
        (sortParser Object)
        [ success "var" $ SortVariableSort (SortVariable (testId "var"))
        , success "sort1{}" $
          SortActualSort
...
metaSortListParserTests =
    parseTree
        ...
        , success
              "{#Char{  }  , #var}"
              [charMetaSort, SortVariableSort (SortVariable (testId "#var"))]
...
objectInCurlyBracesSortVariableListParserTest =
    parseTree
        ...
        , success
              "{var1, var2}"
              [SortVariable (testId "var1"), SortVariable (testId "var2")]
...
sortVariableParserTests =
    parseTree
        ...
        [ success "var" (UnifiedObject (SortVariable (testId "var")))
        , success "#var" (UnifiedMeta (SortVariable (testId "#var")))
        , FailureWithoutMessage ["", "#"]
        ]
...
objectAliasParserTests =
    parseTree
        ...
        [ success
              "c1{}"
              Alias {aliasConstructor = testId "c1", aliasParams = []}
        , success
              "c1{s1}"
              Alias
...
objectSymbolParserTests =
    parseTree
        ...
        [ success
              "c1{}"
              Symbol {symbolConstructor = testId "c1", symbolParams = []}
        , success
              "c1{s1}"
              Symbol
...
bottomPatternParserTests =
    parseTree
        ...
        [ success
              "\\bottom{#Sort}()"
              (asKorePattern $
               BottomPattern $ Bottom (sortVariableSort "#Sort" :: Sort Meta))
        , FailureWithoutMessage
              [ ""
              , "\\bottom()"
              , "\\bottom{}()"
        ...
        [ success
              ...
              (asKorePattern $
               EqualsPattern
                   Equals
                       { equalsOperandSort =
                             sortVariableSort "s1" :: Sort Object
...
topPatternParserTests =
    parseTree
        ...
        [ success
              "\\top{s}()"
              (asKorePattern $
               TopPattern $ Top (sortVariableSort "s" :: Sort Object))
        , FailureWithoutMessage
              ["", "\\top()", "\\top{}()", "\\top{s, s}()", "\\top{s}"]
        ]
              ...
              (constructUnifiedSentence SentenceAxiomSentence $
               (SentenceAxiom
                    { sentenceAxiomParameters =
                          [UnifiedObject (SortVariable (testId "sv1"))]
        ...
        , success
              ...
              (constructUnifiedSentence SentenceAxiomSentence $
               (SentenceAxiom
                    { sentenceAxiomParameters =
                          [ UnifiedObject (SortVariable (testId "sv1"))
                          , UnifiedObject (SortVariable (testId "sv2"))
                          ]
                    , sentenceAxiomPattern =
                          asKorePattern $
                          StringLiteralPattern (StringLiteral "a")
