module Test.Kore.Substitution.List
    ( test_list
    ) where
...
test_list =
    ...
    , testCase
          ...
          (assertEqual
               ...
               (toList $
                insert unifiedMetaVariable objectBottomPattern substitution1))
    , testCase
          "Add binding 2"
          (assertEqual
               ""
               [(unifiedObjectVariable, objectBottomPattern)]
               (toList $
                insert unifiedObjectVariable objectBottomPattern substitution1))
    , testCase
          "Remove binding"
          (assertEqual
               ""
