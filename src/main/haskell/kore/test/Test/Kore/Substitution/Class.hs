...
module Test.Kore.Substitution.Class
    ( test_class
    ) where
...
instance PatternSubstitutionClass S.Substitution Variable UnifiedPattern IntCounter
...
test_class =
    ...
    , testCase
          ...
          (assertEqual
               ...
               (runIntCounter
                    (testSubstitute testSubstitutionStatePattern substitution3)
                    17))
    ]
