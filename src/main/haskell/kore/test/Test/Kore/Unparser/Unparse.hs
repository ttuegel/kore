    ...
    testGroup
        ...
        , testProperty
              ...
              (forAll
                   ...
                   (unparseParseProp (moduleParser koreSentenceParser)))
        , testProperty
              "Definition"
              (forAll
                   (definitionGen koreSentenceGen)
                   (unparseParseProp (definitionParser koreSentenceParser)))
        ]
...
unparseParseTest :: (Pretty a, Eq a, Show a) => Parser a -> a -> TestTree
