...
instance ( EqualWithExplanation child
         , Eq child
         , Show child
         ...
         SumEqualWithExplanation (Pattern level variable child) where
...
instance ( EqualWithExplanation child
         ...
         EqualWithExplanation (Pattern level variable child) where
...
instance SumEqualWithExplanation (StepProof level) where
    ...
    sumConstructorPair a1@(StepProofUnification _) a2 =
        SumConstructorDifferent
            (printWithExplanation a1)
            (printWithExplanation a2)
    ...
    sumConstructorPair a1@(StepProofCombined _) a2 =
        SumConstructorDifferent
            (printWithExplanation a1)
            (printWithExplanation a2)
    sumConstructorPair (StepProofVariableRenamings a1) (StepProofVariableRenamings a2) =
...
instance EqualWithExplanation (StepProof level) where
    compareWithExplanation = sumCompareWithExplanation
    printWithExplanation = show

instance (Show child, EqualWithExplanation child) =>
         StructEqualWithExplanation (And level child) where
    structFieldsWithNames expected@(And _ _ _) actual@(And _ _ _) =
        [ EqWrap "andSort = " (andSort expected) (andSort actual)
        , EqWrap "andFirst = " (andFirst expected) (andFirst actual)
        , EqWrap "andSecond = " (andSecond expected) (andSecond actual)
        ]
    structConstructorName _ = "And"

instance (Show child, EqualWithExplanation child) =>
         EqualWithExplanation (And level child) where
    compareWithExplanation = structCompareWithExplanation
    printWithExplanation = show

instance (Show child, EqualWithExplanation child) =>
         StructEqualWithExplanation (Application level child) where
    structFieldsWithNames expected@(Application _ _) actual@(Application _ _) =
        [ EqWrap
...
instance (Show child, EqualWithExplanation child) =>
         EqualWithExplanation (Application level child) where
    compareWithExplanation = structCompareWithExplanation
    printWithExplanation = show

instance (EqualWithExplanation child, Eq child, Show child) =>
         EqualWithExplanation (Bottom level child) where
    compareWithExplanation = rawCompareWithExplanation
    printWithExplanation = show

instance (Show child, EqualWithExplanation child) =>
         StructEqualWithExplanation (Ceil level child) where
    structFieldsWithNames expected@(Ceil _ _ _) actual@(Ceil _ _ _) =
        [ EqWrap
              "ceilOperandSort = "
        ...
        , EqWrap "ceilChild = " (ceilChild expected) (ceilChild actual)
        ]
    structConstructorName _ = "Ceil"

instance (EqualWithExplanation child, Show child) =>
         EqualWithExplanation (Ceil level child) where
    compareWithExplanation = structCompareWithExplanation
    printWithExplanation = show

instance (EqualWithExplanation child, Eq child, Show child) =>
         EqualWithExplanation (DomainValue level child) where
    compareWithExplanation = rawCompareWithExplanation
    printWithExplanation = show

instance (Show child, EqualWithExplanation child) =>
         StructEqualWithExplanation (Equals level child) where
    structFieldsWithNames expected@(Equals _ _ _ _) actual@(Equals _ _ _ _) =
        [ EqWrap
              "equalsResultSort = "
        ...
        , EqWrap "equalsFirst = " (equalsFirst expected) (equalsFirst actual)
        , EqWrap "equalsSecond = " (equalsSecond expected) (equalsSecond actual)
        ]
    structConstructorName _ = "Equals"

instance (Show child, EqualWithExplanation child) =>
         EqualWithExplanation (Equals level child) where
    compareWithExplanation = structCompareWithExplanation
    printWithExplanation = show
...
instance ( EqualWithExplanation child
         ...
         EqualWithExplanation (Exists level variable child) where
    compareWithExplanation = rawCompareWithExplanation
    printWithExplanation = show

instance (EqualWithExplanation child, Eq child, Show child) =>
         EqualWithExplanation (Floor level child) where
    compareWithExplanation = rawCompareWithExplanation
    printWithExplanation = show
...
instance ( EqualWithExplanation child
         ...
         EqualWithExplanation (Forall level variable child) where
    compareWithExplanation = rawCompareWithExplanation
    printWithExplanation = show

instance (EqualWithExplanation child, Eq child, Show child) =>
         EqualWithExplanation (Iff level child) where
    compareWithExplanation = rawCompareWithExplanation
    printWithExplanation = show

instance (EqualWithExplanation child, Eq child, Show child) =>
         EqualWithExplanation (Implies level child) where
    compareWithExplanation = rawCompareWithExplanation
    printWithExplanation = show

instance (EqualWithExplanation child, Eq child, Show child) =>
         EqualWithExplanation (In level child) where
    compareWithExplanation = rawCompareWithExplanation
    printWithExplanation = show

instance (EqualWithExplanation child, Eq child, Show child) =>
         EqualWithExplanation (Next level child) where
    compareWithExplanation = rawCompareWithExplanation
    printWithExplanation = show

instance (EqualWithExplanation child, Eq child, Show child) =>
         EqualWithExplanation (Not level child) where
    compareWithExplanation = rawCompareWithExplanation
    printWithExplanation = show

instance (EqualWithExplanation child, Eq child, Show child) =>
         EqualWithExplanation (Or level child) where
    compareWithExplanation = rawCompareWithExplanation
    printWithExplanation = show

instance (EqualWithExplanation child, Eq child, Show child) =>
         EqualWithExplanation (Rewrites level child) where
    compareWithExplanation = rawCompareWithExplanation
    printWithExplanation = show
...
instance (EqualWithExplanation child, Eq child, Show child) =>
         EqualWithExplanation (Top level child) where
    compareWithExplanation = rawCompareWithExplanation
    printWithExplanation = show

instance StructEqualWithExplanation (Variable level) where
    structFieldsWithNames expected@(Variable _ _) actual@(Variable _ _) =
        [ EqWrap "variableName = " (variableName expected) (variableName actual)
        , EqWrap "variableSort = " (variableSort expected) (variableSort actual)
        ]
...
instance StructEqualWithExplanation (Id level) where
    structFieldsWithNames expected@(Id _ _) actual@(Id _ _) =
        ...
        , EqWrap "idLocation = " (EWEString "") (EWEString "")
        ]
    structConstructorName _ = "Id"

instance EqualWithExplanation (Id level) where
    compareWithExplanation = structCompareWithExplanation
    printWithExplanation = show

instance EqualWithExplanation (Sort level) where
    compareWithExplanation = rawCompareWithExplanation
    printWithExplanation = show

instance StructEqualWithExplanation (SymbolOrAlias level) where
    structFieldsWithNames expected@(SymbolOrAlias _ _) actual@(SymbolOrAlias _ _) =
        [ EqWrap
...
instance EqualWithExplanation (SymbolOrAlias level) where
    compareWithExplanation = structCompareWithExplanation
    printWithExplanation = show

instance SumEqualWithExplanation (UnificationError level) where
    ...
    sumConstructorPair (NonConstructorHead a1) (NonConstructorHead a2) =
        SumConstructorSameWithArguments (EqWrap "NonConstructorHead" a1 a2)
    sumConstructorPair a1@(NonConstructorHead _) a2 =
        SumConstructorDifferent
            (printWithExplanation a1)
            (printWithExplanation a2)
    sumConstructorPair (NonFunctionalHead a1) (NonFunctionalHead a2) =
        SumConstructorSameWithArguments (EqWrap "NonFunctionalHead" a1 a2)
...
instance EqualWithExplanation (UnificationError level) where
    compareWithExplanation = sumCompareWithExplanation
    printWithExplanation = show

instance (Show (variable level), EqualWithExplanation (variable level)) =>
         SumEqualWithExplanation (SubstitutionError level variable) where
    sumConstructorPair (CircularVariableDependency a1) (CircularVariableDependency a2) =
        SumConstructorSameWithArguments
            (EqWrap "CircularVariableDependency" a1 a2)

instance (Show (variable level), EqualWithExplanation (variable level)) =>
         EqualWithExplanation (SubstitutionError level variable) where
    compareWithExplanation = sumCompareWithExplanation
    printWithExplanation = show

instance (Show (variable level), EqualWithExplanation (variable level)) =>
         SumEqualWithExplanation (StepError level variable) where
...
instance (Show (variable level), EqualWithExplanation (variable level)) =>
         EqualWithExplanation (StepError level variable) where
    compareWithExplanation = sumCompareWithExplanation
    printWithExplanation = show

instance (Eq (variable level), Show (variable level)) =>
         EqualWithExplanation (FunctionalProof level variable) where
    compareWithExplanation = rawCompareWithExplanation
    printWithExplanation = show

instance ( Eq (variable level)
         , Show (variable level)
         , EqualWithExplanation (variable level)
         ) =>
         SumEqualWithExplanation (UnificationProof level variable) where
    ...
    sumConstructorPair a1@EmptyUnificationProof a2 =
        SumConstructorDifferent
            (printWithExplanation a1)
            (printWithExplanation a2)
    sumConstructorPair (CombinedUnificationProof a1) (CombinedUnificationProof a2) =
        SumConstructorSameWithArguments
    ...
    sumConstructorPair a1@(ConjunctionIdempotency _) a2 =
        SumConstructorDifferent
            (printWithExplanation a1)
            (printWithExplanation a2)
    sumConstructorPair (Proposition_5_24_3 a1 a2 a3) (Proposition_5_24_3 b1 b2 b3) =
        SumConstructorSameWithArguments
    ...
    sumConstructorPair a1@(Proposition_5_24_3 _ _ _) a2 =
        SumConstructorDifferent
            (printWithExplanation a1)
            (printWithExplanation a2)
    sumConstructorPair (AndDistributionAndConstraintLifting a1 a2) (AndDistributionAndConstraintLifting b1 b2) =
        SumConstructorSameWithArguments
    ...
    sumConstructorPair a1@(AndDistributionAndConstraintLifting _ _) a2 =
        SumConstructorDifferent
            (printWithExplanation a1)
            (printWithExplanation a2)
    sumConstructorPair (SubstitutionMerge a1 a2 a3) (SubstitutionMerge b1 b2 b3) =
        SumConstructorSameWithArguments
...
instance ( Eq (variable level)
         ...
         EqualWithExplanation (UnificationProof level variable) where
    compareWithExplanation = sumCompareWithExplanation
    printWithExplanation = show
...
instance ( Eq (variable level)
         ...
         StructEqualWithExplanation (UnificationSolution level variable) where
    structFieldsWithNames expected@(UnificationSolution _ _) actual@(UnificationSolution _ _) =
        [ EqWrap
...
instance ( Eq (variable level)
         ...
         EqualWithExplanation (UnificationSolution level variable) where
    compareWithExplanation = structCompareWithExplanation
    printWithExplanation = show

instance StructEqualWithExplanation (VariableRenaming level) where
    structFieldsWithNames expected@(VariableRenaming _ _) actual@(VariableRenaming _ _) =
        [ EqWrap
...
instance EqualWithExplanation (VariableRenaming level) where
    compareWithExplanation = structCompareWithExplanation
    printWithExplanation = show
...
instance EqualWithExplanation (StepperVariable level) where
    compareWithExplanation = sumCompareWithExplanation
    printWithExplanation = show

instance ( Show (variable level)
         , Eq (variable level)
         , EqualWithExplanation (variable level)
         ) =>
         StructEqualWithExplanation (ExpandedPattern level variable) where
    structFieldsWithNames expected@(ExpandedPattern _ _ _) actual@(ExpandedPattern _ _ _) =
        [ EqWrap
              "term = "
...
instance ( Show (variable level)
         ...
         EqualWithExplanation (ExpandedPattern level variable) where
    compareWithExplanation = structCompareWithExplanation
    printWithExplanation = show

instance ( EqualWithExplanation (PureMLPattern level variable)
         , Show (variable level)
         ) =>
         EqualWithExplanation (Predicate level variable) where
...
instance ( Show (variable level)
         ...
         SumEqualWithExplanation (AttemptedFunction level variable) where
    sumConstructorPair AttemptedFunction.NotApplicable AttemptedFunction.NotApplicable =
        SumConstructorSameNoArguments
    sumConstructorPair a1@AttemptedFunction.NotApplicable a2 =
        SumConstructorDifferent
            (printWithExplanation a1)
            (printWithExplanation a2)
    sumConstructorPair (AttemptedFunction.Applied a1) (AttemptedFunction.Applied a2) =
        SumConstructorSameWithArguments (EqWrap "Applied" a1 a2)
...
instance ( Show (variable level)
         ...
         EqualWithExplanation (AttemptedFunction level variable) where
    compareWithExplanation = sumCompareWithExplanation
    printWithExplanation = show

instance EqualWithExplanation (PredicateProof level) where
    compareWithExplanation = rawCompareWithExplanation
    printWithExplanation = show
