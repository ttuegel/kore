...
functionalConstr10
    ...
    => StepPattern Object variable
    -> StepPattern Object variable
functionalConstr10 arg = mkApp testSort functionalConstr10Symbol [arg]
...
sortInjection10
    ...
    => StepPattern Object variable
    -> StepPattern Object variable
sortInjection10 arg = mkApp testSort sortInjection10Symbol [arg]

sortInjection11
    :: Given (SymbolOrAliasSorts Object)
    => StepPattern Object variable
    -> StepPattern Object variable
sortInjection11 arg = mkApp testSort sortInjection11Symbol [arg]

sortInjection0ToTop
    :: Given (SymbolOrAliasSorts Object)
    => StepPattern Object variable
    -> StepPattern Object variable
sortInjection0ToTop arg = mkApp topSort sortInjection0ToTopSymbol [arg]
