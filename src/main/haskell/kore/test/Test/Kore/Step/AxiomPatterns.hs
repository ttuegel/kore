...
import Kore.AST.Kore (asKorePattern)
...
test_axiomPatterns = [axiomPatternsUnitTests, axiomPatternsIntegrationTests]
              ...
              (assertEqual
                   ...
                   (koreSentenceToAxiomPattern Object $
                    ...
                    axiomSentencePureToKore
                        (axiom_ (and_ top_ (and_ top_ (rewrites_ varI1 varI2))) :: PureSentenceAxiom Object)))
        , testCase
              "definition containing I1:AInt => I2:AInt"
              (assertEqual
                   ""
                   [ AxiomPattern
                         { axiomPatternLeft = extractPurePattern varI1
                                                          ...
                                                          (axiom_
                                                               (and_
                                                                    ...
                                                                    (and_
                                                                         ...
                                                                         (rewrites_
                                                                              varI1
                                                                              varI2))) :: PureSentenceAxiom Object)
                                                    , asSentence $
                                                      axiomSentencePureToKore
                                                          (axiom_
                                                               (and_
                             ...
                             (and_
                                  ...
                                  (and_
                                       ...
                                       (applyPS
                                            symbolInj
                                            [sortAInt, sortKItem]
                                            [rewrites_ varI1 varI2]))) :: PureSentenceAxiom Object)))
        ]
...
symbolTCell = symbol_ "T" AstLocationTest [sortKCell, sortStateCell] sortTCell

-- symbol T{}(KCell{}, StateCell{}) : TCell{} []
symbolKCell = symbol_ "k" AstLocationTest [sortK] sortKCell

symbolKSeq, symbolInj :: PureSentenceSymbol Object
symbolKSeq = symbol_ "kseq" AstLocationTest [sortKItem, sortK] sortK
...
symbolLeqAExp = symbol_ "leqAExp" AstLocationTest [sortAExp, sortAExp] sortBExp

symbolLeqAInt :: PureSentenceSymbol Object
symbolLeqAInt = symbol_ "leqAInt" AstLocationTest [sortAInt, sortAInt] sortABool
