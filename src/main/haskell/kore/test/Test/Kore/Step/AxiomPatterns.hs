...
symbolTCell = mkSymbol (testId "T") [sortKCell, sortStateCell] sortTCell
...
applyTCell kCell stateCell =
    applySymbol symbolTCell [kCell, stateCell]

symbolKCell = mkSymbol (testId "k") [sortK] sortKCell
applyKCell
    :: CommonStepPattern Object
    -> CommonStepPattern Object
applyKCell child = applySymbol symbolKCell [child]

symbolKSeq, symbolInj :: SentenceSymbol Object (CommonStepPattern Object)
symbolKSeq = mkSymbol (testId "kseq") [sortKItem, sortK] sortK
...
applyKSeq kHead kTail =
    applySymbol symbolKSeq [kHead, kTail]
...
symbolLeqAExp = mkSymbol (testId "leqAExp") [sortAExp, sortAExp] sortBExp
...
applyLeqAExp child1 child2 =
    applySymbol symbolLeqAExp [child1, child2]

symbolLeqAInt :: SentenceSymbol Object (CommonStepPattern Object)
symbolLeqAInt = mkSymbol (testId "leqAInt") [sortAInt, sortAInt] sortABool

applyLeqAInt
    :: CommonStepPattern Object
    -> CommonStepPattern Object
    -> CommonStepPattern Object
applyLeqAInt child1 child2 = applySymbol symbolLeqAInt [child1, child2]
