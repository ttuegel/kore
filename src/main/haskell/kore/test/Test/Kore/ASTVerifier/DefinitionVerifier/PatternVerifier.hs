...
newtype VariableOfDeclaredSort level =
    VariableOfDeclaredSort (Variable level)

testPatternErrorStackStrings :: TestPattern level -> [String]
testPatternErrorStackStrings TestPattern {testPatternErrorStack = ErrorStack strings} =
    strings

testPatternUnifiedPattern ::
       MetaOrObject level => TestPattern level -> CommonKorePattern
testPatternUnifiedPattern TestPattern {testPatternPattern = p} = asKorePattern p
...
test_patternVerifier =
    ...
    , successTestsForObjectPattern
          ...
          (simpleExistsPattern objectVariableSortVariable objectSortVariableSort)
          (NamePrefix "dummy")
    ...
    , failureTestsForObjectPattern
          ...
          (SortVariablesThatMustBeDeclared [])
          (DeclaredSort anotherSort)
          [objectSortSentence, anotherSortSentence, anotherObjectSortSentence2]
          NeedsInternalDefinitions
    , failureTestsForMetaPattern
    ...
    , failureTestsForObjectPattern
          ...
          (ErrorStack
               ["symbol or alias 'ObjectSymbol' (<test data>)", "(<test data>)"])
          (applicationPatternWithChildren
               objectSymbolName
               [ simpleExistsObjectUnifiedPattern
                     objectVariableName
...
successTestsForObjectPattern ::
    ...
    -> PatternRestrict
    -> TestTree
successTestsForObjectPattern description testedPattern namePrefix testedSort sortVariables anotherSort sentences patternRestrict =
...
successTestsForMetaPattern ::
    ...
    -> PatternRestrict
    -> TestTree
successTestsForMetaPattern description testedPattern namePrefix testedSort sortVariables objectSortVariables anotherSort dummyVariable sentences patternRestrict =
    successTestDataGroup description testData
  where
    testData =
        genericPatternInAllContexts
...
failureTestsForObjectPattern ::
    ...
    -> PatternRestrict
    -> TestTree
failureTestsForObjectPattern description errorMessage errorStackSuffix testedPattern namePrefix@(NamePrefix rawNamePrefix) testedSort sortVariables anotherSort sentences patternRestrict =
...
failureTestsForMetaPattern ::
    ...
    -> PatternRestrict
    -> TestTree
failureTestsForMetaPattern description errorMessage errorStackSuffix testedPattern namePrefix testedSort sortVariables objectSortVariables anotherSort dummyVariable sentences patternRestrict =
    failureTestDataGroup description errorMessage errorStackSuffix testData
  where
    testData =
        genericPatternInAllContexts
...
genericPatternInAllContexts ::
    ...
    -> PatternRestrict
    -> [TestData]
genericPatternInAllContexts x testedPattern (NamePrefix namePrefix) (TestedPatternSort testedSort) sortVariables objectSortVariables (DeclaredSort anotherSort) dummyVariable sentences patternRestrict =
...
objectPatternInAllContexts ::
    ...
    -> PatternRestrict
    -> [TestData]
objectPatternInAllContexts testedPattern (NamePrefix namePrefix) (TestedPatternSort testedSort) sortVariables (DeclaredSort anotherSort) =
    patternsInAllContexts
        Object
        patternExpansion
        (NamePrefix namePrefix)
...
patternsInAllContexts ::
    ...
    -> PatternRestrict
    -> [TestData]
patternsInAllContexts x patterns (NamePrefix namePrefix) sortVariables objectSortVariables (DeclaredSort anotherSort) sentences patternRestrict =
            ...
            SentenceSymbol
                { sentenceSymbolSymbol =
                      Symbol
                          ...
                          , symbolParams =
                                [SortVariable (testId rawSortVariableName)]
                          }
...
genericPatternInPatterns ::
    ...
    -> PatternRestrict
    -> [TestPattern level]
genericPatternInPatterns testedPattern anotherPattern sort@(OperandSort testedSort) resultSort (VariableOfDeclaredSort dummyVariable) symbol alias patternRestrict =
...
patternInUnquantifiedGenericPatterns ::
    ...
    -> Helpers.ResultSort level
    -> [TestPattern level]
patternInUnquantifiedGenericPatterns testedPattern anotherPattern (OperandSort testedSort) (Helpers.ResultSort resultSort) =
    [ TestPattern
          { testPatternPattern =
                AndPattern
                    And
    ...
    , TestPattern
          { testPatternPattern =
                NotPattern
                    Not {notSort = testedSort, notChild = testedUnifiedPattern}
          , testPatternSort = testedSort
          , testPatternErrorStack = ErrorStack ["\\not (<test data>)"]
          }
    , TestPattern
...
patternInUnquantifiedObjectPatterns ::
    ...
    -> OperandSort Object
    -> [TestPattern Object]
patternInUnquantifiedObjectPatterns testedPattern anotherPattern (OperandSort testedSort) =
    [ TestPattern
          { testPatternPattern =
                NextPattern
                    Next
...
testsForUnifiedPatternInTopLevelContext x namePrefix additionalSort sortVariables objectSortVariables additionalSentences patternRestrict =
...
testsForUnifiedPatternInTopLevelGenericContext ::
    ...
    -> PatternRestrict
    -> [TestPattern level -> TestData]
testsForUnifiedPatternInTopLevelGenericContext x (NamePrefix namePrefix) (DeclaredSort additionalSort) (SortVariablesThatMustBeDeclared sortVariables) additionalSentences patternRestrict =
     ...
     in case patternRestrict of
            ...
            NeedsAttributes ->
                [ \testPattern ->
                      TestData
                          { testDataDescription =
                                "Pattern in alias definition attributes"
                          , testDataError =
                                Error
                                    ("module 'MODULE'" :
                                     ("alias '" ++
                                      rawAliasName ++ "' declaration") :
                                     "attributes" :
                                     "\\equals (<test data>)" :
                                     "\\equals (<test data>)" :
                                     testPatternErrorStackStrings testPattern)
                ...
                , \testPattern ->
                      TestData
                          { testDataDescription =
                                "Pattern in symbol definition attributes"
                          , testDataError =
                                Error
                                    ("module 'MODULE'" :
                                     ("symbol '" ++
                                      rawSymbolName ++ "' declaration") :
                                     "attributes" :
                                     "\\equals (<test data>)" :
                                     "\\equals (<test data>)" :
                                     testPatternErrorStackStrings testPattern)
...
testsForUnifiedPatternInTopLevelObjectContext ::
    ...
    -> PatternRestrict
    -> [TestPattern level -> TestData]
testsForUnifiedPatternInTopLevelObjectContext (SortName rawSortName) (SortVariablesThatMustBeDeclared sortVariables) additionalSentences patternRestrict =
    case patternRestrict of
        NeedsInternalDefinitions -> []
        _ ->
            [ \testPattern ->
                  TestData
                      ...
                      , testDataError =
                            Error
                                ("module 'MODULE'" :
                                 ("sort '" ++
                                  rawSortName ++ "' declaration (<test data>)") :
                                 "attributes" :
                                 "\\equals (<test data>)" :
                                 "\\equals (<test data>)" :
                                 testPatternErrorStackStrings testPattern)
                    ...
                    { testPatternPattern =
                          EqualsPattern
                              Equals
                                  ...
                                  , equalsResultSort =
                                        attributeObjectSort AstLocationTest
                                  , equalsFirst = asKorePattern patternPattern
                                  , equalsSecond = asKorePattern patternPattern
                                  }
                    , testPatternSort = attributeObjectSort AstLocationTest
                    , testPatternErrorStack = testPatternErrorStack testPattern
                    }
        IsObject
