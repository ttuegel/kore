...
test_imports = [importTests, nameVisibilityTests, nameDuplicationTests]
...
sortVisibilityTests =
  ...
  where
    sort =
        SortActualSort
            SortActual {sortActualName = testId "sort1", sortActualSorts = []} :: Sort Object
    sortDeclaration =
        asSentence
            (SentenceSort
    ...
    anotherSort =
        SortActualSort
            SortActual {sortActualName = testId "sort3", sortActualSorts = []} :: Sort Object
    ...
    metaTopSortPattern = asKorePattern (TopPattern Top {topSort = charMetaSort})
    sortReferenceInSort =
        SortActualSort
            SortActual
                {sortActualName = testId "sort2", sortActualSorts = [sort]} :: Sort Object
        ...
        asSentence
            (SentenceAlias
                 ...
                 , sentenceAliasLeftPattern =
                       TopPattern $ Top {topSort = defaultSort}
...
defaultSort =
    SortActualSort
        SortActual {sortActualName = testId "sort1", sortActualSorts = []}
...
newtype DeclaringSentence =
    DeclaringSentence KoreSentence

newtype UsingSentence =
    UsingSentence KoreSentence

newtype SupportingSentences =
    SupportingSentences [KoreSentence]
...
nameReferenceTests ::
    ...
    -> SupportingSentences
    -> TestTree
nameReferenceTests description expectedErrorMessage additionalErrorStack declaringSentence usingSentence supportingSentences =
    testGroup
        description
        (nameReferenceSuccessTests
             declaringSentence
...
nameReferenceSuccessTests (DeclaringSentence declaringSentence) (UsingSentence usingSentence) (SupportingSentences supportingSentences) =
    [ expectSuccess
...
nameReferenceFailureTests ::
    ...
    -> SupportingSentences
    -> [TestTree]
nameReferenceFailureTests (ExpectedErrorMessage expectedErrorMessage) (ErrorStack additionalErrorStack) (DeclaringSentence declaringSentence) (UsingSentence usingSentence) (SupportingSentences supportingSentences) =
    [ expectFailureWithError
            ...
            , moduleSentences =
                  [ asSentence
                        (SentenceAlias
                             ...
                             , sentenceAliasLeftPattern =
                                   TopPattern $
                                   Top {topSort = simpleSort (SortName "s1")}
                             , sentenceAliasRightPattern =
                                   TopPattern $
                                   Top {topSort = simpleSort (SortName "s1")}
                             , sentenceAliasAttributes = Attributes []
