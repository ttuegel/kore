module Test.Kore.ASTVerifier.DefinitionVerifier.Attributes
    ( test_attributes
    ) where
...
test_attributes =
    [ expectSuccess
          "Attribute sorts and symbols visible in attributes"
          Definition
    ...
    , expectFailureWithError
          "Non-attribute sort not visible in attributes"
          (Error
               [ "module 'M1'"
               , "axiom declaration"
               , "attributes"
        ...
        asKorePattern
            (DomainValuePattern
                 DomainValue
                     ...
                     , domainValueChild =
                           asKorePattern
                               (StringLiteralPattern (StringLiteral "asgn"))
                     })
    sortSwitchingEquals ::
           OperandSort Object
        -> ResultSort Object
        -> CommonKorePattern
        -> CommonKorePattern
    sortSwitchingEquals (OperandSort operandSort) (ResultSort resultSort) child =
        asKorePattern
            (EqualsPattern
                 Equals
