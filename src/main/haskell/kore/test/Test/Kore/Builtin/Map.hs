...
prop_inKeysUnit k =
    let patInKeys = App_ symbolInKeys [ patUnit, patKey ]
        patKey = Test.Int.asPattern k
        patUnit = App_ symbolUnit []
    in
...
prop_inKeysElement (key, value) =
    let patInKeys = App_ symbolInKeys [ patMap, patKey ]
    ...
    Module
        ...
        , moduleSentences =
            ...
            , hookedSymbolDecl "MAP.in_keys" symbolInKeys
                Test.Bool.boolSort [mapSort, Test.Int.intSort]
            ]
        }
