    ...
    parseTree koreSentenceParser
        ...
        , success "alias f{s}() : s where f{s}() := \\dv{s}(\"f\") []"
            (   let
                ...
                in SentenceAliasSentence SentenceAlias
                    ...
                    , sentenceAliasRightPattern =
                        (asParsedPattern . DomainValueF) DomainValue
        ...
        , success
            ...
            (   let
                    ...
                    argument = asParsedPattern . VariableF . var
                    varA = var "a"
                    varB = var "b"
                    argA = argument "a"
                    argB = argument "b"
        ...
        , success
            ...
            (   let
                    ...
                    arg = asParsedPattern (VariableF var)
                in SentenceAliasSentence SentenceAlias
                    { sentenceAliasAlias = Alias
                        { aliasConstructor = aliasId
                        , aliasParams = [sortVar]
